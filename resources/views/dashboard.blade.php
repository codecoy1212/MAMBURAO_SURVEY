        ...
        <div class="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
            ...
            <div class="text-center col-span-12 mt-8">
                ...
                <div class="grid grid-cols-12 gap-6 mt-5 xl:ml-20 xl:mr-20">
                    <a class="col-span-12 sm:col-span-6 xl:col-span-4 intro-y" href="{{route('nene')}}">
                        <div class="zoom-in" >
                    ...
                    <a class="col-span-12 sm:col-span-6 xl:col-span-4 intro-y" href="{{route('philip')}}">
                        <div class="zoom-in">
                            <div class="box p-6 border-theme-1 border-2">
                                <div class="flex">
                                    <i style="width:43px; height:43px;" data-feather="users" class="report-box__icon text-theme-1 m-auto"></i>
                    ...
                    <a class="col-span-12 sm:col-span-6 xl:col-span-4 intro-y" href="{{route('eric')}}">
                        <div class="zoom-in">
                            <div class="box p-6 border-theme-1 border-2">
                                <div class="flex">
                                    <i style="width:43px; height:43px;" data-feather="users" class="report-box__icon text-theme-1 m-auto"></i>
